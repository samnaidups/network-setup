...
**2** Now, Lets consider admin of org1 sends the channel creation request to the orderer<br/>
     Run the following command in cli1 terminal <br/>
...
**3** Execute the command that will request the org1 peer to join the channel<br/>
     ```sh
       peer channel join -b <channel-ID.block>
     ```<br/>
**4** Now lets join the peers of org2, Go to the cli2 terminal and run the following command<br/>
 ```sh
